...
def generate_image(prompt):
    ...
    if not api_key or "your_" in api_key:
        ...
        return "https://via.placeholder.com/512?text=API+Key+Missing"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return f"https://via.placeholder.com/512?text=Image+gen+failed+({response.status_code})"
    except Exception as e:
        print(f"Error calling Stability API: {e}")
        return "https://via.placeholder.com/512?text=Connection+Error"
